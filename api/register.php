...
// IF THERE ARE NO EMPTY FIELDS THEN-
    ...
    elseif(strlen($name) < 3):
        $returnData = msg('false',422,'Your name must be at least 3 characters long!');
        ...
        try{
            ...
            if($check_email_stmt->rowCount()):
                $returnData = msg('false',422, 'This E-mail already in use!');
                ...
                $returnData = msg('true',201,'You have successfully registered.');
